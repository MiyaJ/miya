package com.miya.gateway.handler;
...
/**
 * @author Caixiaowei
 * @ClassName MiyaGatewayExceptionHandler.java
 * @Description 网关异常处理
 * @createTime 2020年05月14日 15:25:00
 */
@Slf4j
public class MiyaGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public MiyaGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
