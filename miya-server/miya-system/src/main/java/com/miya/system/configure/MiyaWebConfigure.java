...
import com.miya.system.properties.SwaggerProperties;
...
/**
 * @author Caixiaowei
 * @ClassName MiyaWebConfigure.java
 * @Description web 配置
 * @createTime 2020年05月14日 14:17:00
 */
@Configuration
@EnableSwagger2
public class MiyaWebConfigure {

    @Autowired
    private ServerSystemProperties properties;

    /**
     * @title mybatis plus 分页配置
     * @description
     * @author Caixiaowei
     * @updateTime 2020/5/14 14:18
     * @throws
     */
    @Bean
