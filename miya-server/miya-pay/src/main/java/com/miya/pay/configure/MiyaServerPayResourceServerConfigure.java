package com.miya.pay.configure;
...
/**
 * @author Caixiaowei
 * @ClassName MiyaServerPayResourceServerConfigure.java
 * @Description 资源服务器的配置
 * @createTime 2020年05月12日 16:42:00
 */
@Configuration
@EnableResourceServer
public class MiyaServerPayResourceServerConfigure extends ResourceServerConfigurerAdapter {
    ...
    private String anonUrl = "/swagger-ui.html,/webjars/**,/swagger-resources/**,/v2/api-docs/**,/,/csrf,/test/**";
