...
public class SortUtil {
    ...
    public static void handlePageSort(QueryRequest request, Page<?> page, String defaultSort, String defaultOrder,
        ...
        if (camelToUnderscore) {
            sortField = MiyaUtil.camelToUnderscore(sortField);
            defaultSort = MiyaUtil.camelToUnderscore(defaultSort);
        }
        if (StringUtils.isNotBlank(request.getField())
            ...
            if (StringUtils.equals(request.getOrder(), MiyaConstant.ORDER_DESC)) {
            ...
            if (StringUtils.isNotBlank(defaultSort)) {
                if (StringUtils.equals(defaultOrder, MiyaConstant.ORDER_DESC)) {
